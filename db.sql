...
# Database: cubeshop
# Generation Time: 2020-06-12 06:32:46 +0000
# ************************************************************
...
VALUES
	(1,'pbkdf2_sha256$180000$dnuHY5tZXMiS$pVspBHibZlJ+a8MDGMSPmWl94NqCFnjzB6qc3rfxIFM=','2020-06-12 06:32:33.949641',1,'1','','','',1,1,'2020-06-07 04:20:34.800426'),
	(2,'pbkdf2_sha256$180000$TZaKRFxDhhTi$8pZb5h1ujhepvGK20QHMiF4rcbQhrgFerTpqx2XwH0M=','2020-06-11 09:43:22.285459',0,'tom','','','',0,1,'2020-06-07 08:24:47.139110'),
...
VALUES
	...
	(17,'server','0001_initial','2020-06-07 04:11:37.749958'),
	(18,'sessions','0001_initial','2020-06-07 04:11:37.933232'),
	(19,'server','0002_showcaserental_responsible','2020-06-09 10:26:55.422179'),
	(20,'server','0003_receipt_discount','2020-06-10 14:11:38.881830'),
	(21,'server','0004_auto_20200610_1418','2020-06-10 14:18:38.110395'),
	(22,'server','0005_auto_20200610_1422','2020-06-10 14:22:32.828399'),
	(23,'server','0006_auto_20200610_1426','2020-06-10 14:28:03.726125'),
	(24,'server','0007_auto_20200611_0612','2020-06-11 06:12:51.488410'),
	(25,'server','0008_auto_20200611_1041','2020-06-11 10:41:54.836995'),
	(26,'server','0009_inventory_owner','2020-06-12 06:10:52.164690');
...
VALUES
	...
	('q7mnddmipmgle9hj2sybqxgejkm7v6e2','MmYyMDM3YzFkMjI2Yzk1MTEyYzhlNTg1Yjc1MDRhODdiMzljOTkwMDp7Il9hdXRoX3VzZXJfaWQiOiIyIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiJjZTM1OWZiOTMxYTRjMGVkZWY1MmJjZmQ0NmE5MWY3OTg3ZWNiZjMxIn0=','2020-06-25 09:17:52.353679'),
...
INSERT INTO `server_inventory` (`inventory_id`, `unit_price`, `stock_in_qty`, `remark`, `from_showcase_id`, `from_stock_id`, `owner_id`)
VALUES
	(1,98.0,423,NULL,'KF001',1,2),
	(3,98.0,10,NULL,'KF002',1,2),
	(5,98.0,10,NULL,'MK1001',1,2),
	(6,15.0,10,NULL,'KF001',2,2);
...
INSERT INTO `server_showcase` (`showcase_id`, `showcase_type`, `rental_index`, `from_tenant_id`, `store_id`)
VALUES
	('KF001','N',2,2,'KF'),
	('KF002','V',0,2,'KF'),
	('MK1001','V',0,NULL,'MK1'),
...
VALUES
	('CEN','中環','中環畢打街',1,0,NULL),
	('CWB','Causeway Bay','Causeway Bay',1,0,NULL),
	('KF','Kwai Fong','Kwai Fong',1,2,NULL),
	('MK1','Mong Kok #1','Mong Kok Fa Yueen Street',1,9,NULL),
	('ST','Sha Tin','Sha Tin',1,0,NULL);
...
VALUES
	(2,'Tom','91746899','香港','2020-06-07',420.6,5.5,2),
	(4,'Name','12345678','Add','2020-06-08',0.0,5.5,4),
	(5,'Ben','12345678','HK','2020-06-09',0.0,5.5,5),
	(7,'黃大仙','12345678','黃大仙中心','2020-06-11',0.0,5.5,7);
